...
def add_args(parser):
    ...
    parser.add_argument('--data_dir', type=str, default='E:\桌面2.25\生成数据\client num\0.2.xlsx',
                        help='test directory')
    ...
    parser.add_argument('--epochs_of_local_fine_tuning', type=int, default=200,
                        help='the frequency of the algorithms')

    parser.add_argument('--if_join_midway', type=bool, default=False,
...
if __name__ == "__main__":
    ...
    '''wandb.init(
        project="test",
        #project="fedml",
        name="实验共享10.2 " + str(args.comm_round) + "-e" + str(args.epochs) + "-lr" + str(args.lr),
        config=args
    )'''
