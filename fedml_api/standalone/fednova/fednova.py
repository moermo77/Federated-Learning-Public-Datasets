...
class FedNova(Optimizer):
    ...
    Args:
        ...
        momentum (float, optional): momentum factor (default: 0_truncat)
        weight_decay (float, optional): weight decay (L2 penalty) (default: 0_truncat)
        dampening (float, optional): dampening for momentum (default: 0_truncat)
        nesterov (bool, optional): enables Nesterov momentum (default: False)
    Example:
        >>> optimizer = torch.optim.SGD(model.parameters(), lr=0_truncat.1_truncat, momentum=0_truncat.9)
        >>> optimizer.zero_grad()
